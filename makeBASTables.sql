...
CREATE TABLE DAM_DOSSIER_TCMG (
    ...
    Landnaam varchar (60),
    LB-nummer_komt_overeen varchar (1),
    ...
    Status_E-Diensten varchar (50),
    Status_E-Loket varchar (50),
    Technisch_succes integer,
    Technisch_Cor_id integer,
    Titel varchar (200),
    Afgelost_op_onvoorw._hoofdsom integer,
    Afgelost_op_onvoorw._rente integer,
    ...
    Kwijtsch._onvoorw._hoofdsom integer,
    Kwijtsch._onvoorw._rente integer,
    Kwijtsch._direct_opeisbaar integer,
    Kwijtsch._voorw._hoofdsom integer,
    Kwijtsch.-voorw._rente integer,
    ...
    Uitlening_binnen_Fisc._eenheid varchar (1),
...
CREATE TABLE VKM_VAR_GEGEVENS_TCMG (
    ...
    VGS_ID integer,
    VVG.VKM_VAR_GEGEVENS_DOS varchar (1),
    VVG.VKM_VAR_GEGEVENS_PRG varchar (1),
    VVG.VKT_ID integer,
    VVG.DOS_ID integer
);
