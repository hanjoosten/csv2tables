...
CREATE TABLE BAS_RBM_ORG_FAILLIET (
    ...
    Kvk_subdossiernr varchar (4),
    Naam varchar (500),
    Handelsnaam varchar (500),
    Straatnaam_postbus varchar (255),
    Huisnr_postbusnr varchar (255),
    Huisnr_toevoeging varchar (50),
    Postcode varchar (50),
...
CREATE TABLE BAS_VKM_VAR_GEGEVENS (
    ...
    DROPDOWNLIST_01 varchar (255),
    DROPDOWNLIST_02 varchar (255),
    DROPDOWNLIST_03 varchar (255),
    DROPDOWNLIST_04 varchar (255),
    DROPDOWNLIST_05 varchar (255),
    DROPDOWNLIST_06 varchar (255),
    DROPDOWNLIST_07 varchar (255),
    DROPDOWNLIST_08 varchar (255),
    DROPDOWNLIST_09 varchar (255),
    DROPDOWNLIST_10 varchar (255),
    DROPDOWNLIST_11 varchar (255),
    DROPDOWNLIST_12 varchar (255),
    DROPDOWNLIST_13 varchar (255),
    DROPDOWNLIST_14 varchar (255),
    DROPDOWNLIST_15 varchar (255),
    DROPDOWNLIST_16 varchar (255),
    DROPDOWNLIST_17 varchar (255),
    DROPDOWNLIST_18 varchar (255),
    DROPDOWNLIST_19 varchar (255),
    DROPDOWNLIST_20 varchar (255),
    DROPDOWNLIST_21 varchar (255),
    DROPDOWNLIST_22 varchar (255),
    DROPDOWNLIST_23 varchar (255),
    DROPDOWNLIST_24 varchar (255),
    DROPDOWNLIST_25 varchar (255),
    DROPDOWNLIST_26 varchar (255),
    DROPDOWNLIST_27 varchar (255),
    DROPDOWNLIST_28 varchar (255),
    DROPDOWNLIST_29 varchar (255),
    DROPDOWNLIST_30 varchar (255),
    DROPDOWNLIST_31 varchar (255),
    DROPDOWNLIST_32 varchar (255),
    DROPDOWNLIST_33 varchar (255),
    DROPDOWNLIST_34 varchar (255),
    DROPDOWNLIST_35 varchar (255),
    DROPDOWNLIST_36 varchar (255),
    DROPDOWNLIST_37 varchar (255),
    DROPDOWNLIST_38 varchar (255),
    DROPDOWNLIST_39 varchar (255),
    DROPDOWNLIST_40 varchar (255),
    INT_01 bigint,
    INT_02 bigint,
    INT_03 bigint,
    INT_04 bigint,
    ...
    OPTIONBUTTON_01 varchar (255),
    OPTIONBUTTON_02 varchar (255),
    OPTIONBUTTON_03 varchar (255),
    OPTIONBUTTON_04 varchar (255),
    OPTIONBUTTON_05 varchar (255),
    OPTIONBUTTON_06 varchar (255),
    OPTIONBUTTON_07 varchar (255),
    OPTIONBUTTON_08 varchar (255),
    OPTIONBUTTON_09 varchar (255),
    OPTIONBUTTON_10 varchar (255),
    OPTIONBUTTON_11 varchar (255),
    OPTIONBUTTON_12 varchar (255),
    OPTIONBUTTON_13 varchar (255),
    OPTIONBUTTON_14 varchar (255),
    OPTIONBUTTON_15 varchar (255),
    OPTIONBUTTON_16 varchar (255),
    OPTIONBUTTON_17 varchar (255),
    OPTIONBUTTON_18 varchar (255),
    OPTIONBUTTON_19 varchar (255),
    OPTIONBUTTON_20 varchar (255),
    ...
    VARCHAR_60_01 varchar (255),
    VARCHAR_60_02 varchar (255),
    VARCHAR_60_03 varchar (255),
    VARCHAR_60_04 varchar (255),
    VARCHAR_60_05 varchar (255),
    VARCHAR_60_06 varchar (255),
    VARCHAR_60_07 varchar (255),
    VARCHAR_60_08 varchar (255),
    VARCHAR_60_09 varchar (255),
    VARCHAR_60_10 varchar (255),
    VARCHAR_60_11 varchar (255),
    VARCHAR_60_12 varchar (255),
    VARCHAR_60_13 varchar (255),
    VARCHAR_60_14 varchar (255),
    VARCHAR_60_15 varchar (255),
    VARCHAR_60_16 varchar (255),
    VARCHAR_60_17 varchar (255),
    VARCHAR_60_18 varchar (255),
    VARCHAR_60_19 varchar (255),
    VARCHAR_60_20 varchar (255),
    VARCHAR_60_21 varchar (255),
    VARCHAR_60_22 varchar (255),
    VARCHAR_60_23 varchar (255),
    VARCHAR_60_24 varchar (255),
    VARCHAR_60_25 varchar (255),
    VARCHAR_60_26 varchar (255),
    VARCHAR_60_27 varchar (255),
    VARCHAR_60_28 varchar (255),
    VARCHAR_60_29 varchar (255),
    VARCHAR_60_30 varchar (255),
    VARCHAR_60_31 varchar (255),
    VARCHAR_60_32 varchar (255),
    VARCHAR_60_33 varchar (255),
    VARCHAR_60_34 varchar (255),
    VARCHAR_60_35 varchar (255),
    VARCHAR_60_36 varchar (255),
    VARCHAR_60_37 varchar (255),
    VARCHAR_60_38 varchar (255),
    VARCHAR_60_39 varchar (255),
    VARCHAR_60_40 varchar (255),
    VGS_ID bigint,
