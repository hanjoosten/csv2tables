...
CREATE TABLE BAS_DAM_DECLARATIE (
    techId INTEGER PRIMARY KEY,
    Adviesaangevraagd double precision,
    Adviesaantaluren bigint,
    Advieshandtoegekend double precision,
    Adviesrente double precision,
    Adviesrentedatum timestamp,
    Adviestoegekend double precision,
    ...
    Dos_id bigint,
    Herstel varchar (1),
    Inboedeltuinaangevraagd double precision,
    Inboedeltuinhandtoegekend double precision,
    Inboedeltuinrente double precision,
    inboedeltuinrentedatum timestamp,
    Inboedeltuintoegekend double precision,
    Inkomstendervingaangevraagd double precision,
    Inkomstendervinghandtoegekend double precision,
    Inkomstendervingrente double precision,
    Inkomstendervingrentedatum timestamp,
    Inkomstendervingtoegekend double precision,
    Juridischaangevraagd double precision,
    Juridischaantaluren bigint,
    Juridischhandtoegekend double precision,
    Juridischrente double precision,
    Juridischrentedatum timestamp,
    Juridischtarief double precision,
    Juridischtoegekend double precision,
    Mutatie_dat timestamp,
    Mutatie_user varchar (30),
    Notitie varchar (2048),
    Oorzaak varchar (2048),
    Opslagaangevraagd double precision,
    Opslagaantalweken bigint,
    Opslaghandtoegekend double precision,
    opslagrente double precision,
    Opslagrentedatum timestamp,
    Opslagtoegekend double precision,
    Overlastaangevraagd double precision,
    Overlasthandtoegekend double precision,
    Overlastrente double precision,
    Overlasttoegekend double precision,
    Overlastvergoeding varchar (1),
    Overnachtenaangevraagd double precision,
    Overnachtenaantalnachten bigint,
    Overnachtenaantalpersonen varchar (20),
    Overnachtenhandtoegekend double precision,
    Overnachtenrente double precision,
    Overnachtenrentedatum timestamp,
    Overnachtentoegekend double precision,
    Reisaangevraagd double precision,
    Reisaantalkm bigint,
    Reishandtoegekend double precision,
    Reisov double precision,
    Reisrente double precision,
    Reisrentedatum timestamp,
    Reistoegekend double precision,
    Schoonmaakaangevraagd double precision,
    Schoonmaakhandtoegekend double precision,
    Schoonmaakrente double precision,
    Schoonmaaktoegekend double precision,
    Schoonmaakvergoeding varchar (1),
    Thuisblijfherstelaangevraagd double precision,
    Thuisblijfherstelaantaldagdeel bigint,
    Thuisblijfherstelhandtoegekend double precision,
    Thuisblijfherstelrente double precision,
    Thuisblijfhersteltoegekend double precision,
    Thuisblijfherstelvergoeding varchar (1),
    Thuisblijfopnameaangevraagd double precision,
    Thuisblijfopnamehandtoegekend double precision,
    Thuisblijfopnamerente double precision,
    Thuisblijfopnametoegekend double precision,
    Thuisblijfopnamevergoeding varchar (1),
    Totaalrente double precision,
    Totaaltoegekend double precision,
    Verhuisaangevraagd double precision,
    Verhuishandtoegekend double precision,
    Verhuisrente double precision,
    Verhuisrentedatum timestamp,
    Verhuistoegekend double precision,
    Zorgaangevraagd double precision,
    Zorghandtoegekend double precision,
    Zorgrente double precision,
    Zorgrentedatum timestamp,
    Zorgtoegekend double precision
);
...
CREATE TABLE BAS_DAM_DEELNAME (
    ...
    Geclaimd double precision,
    Geclaimd_NLG double precision,
    Gedeclareerd double precision,
    Gedeclareerd_NLG double precision,
    Gerealiseerd double precision,
    Gerealiseerd_NLG double precision,
    Geschoond double precision,
    Geschoond_NLG double precision,
    IBAN varchar (34),
    Ingediend double precision,
    Ingediend_NLG double precision,
    ...
    Totaal_decl_deelname double precision,
    Totaal_uitb_deelname double precision,
...
CREATE TABLE BAS_DAM_DOS_BUDGETREGEL (
    ...
    Rpt_nr bigint,
    Bgt_cd varchar (1),
    Verleend double precision,
    Ingetrokken double precision,
    Gedeclareerd double precision,
    Betaald double precision,
    Vastgesteld double precision,
    Openstaand double precision,
    Opeisbaar double precision,
    Def_verleend double precision,
    Def_ingetrokken double precision,
    Def_gedeclareerd double precision,
    Def_openstaand double precision,
    Creatie_dat timestamp,
    Creatie_user varchar (30),
    Mutatie_dat timestamp,
    Mutatie_user varchar (30),
    Rpe_datum_van timestamp,
    Neg_einddeclaratie double precision,
    Prg_id bigint,
    Reg_id bigint,
    Reg_nr smallint,
    Afl_neg_einddeclaratie double precision,
    Def_neg_einddeclaratie double precision,
    Cvk_id bigint,
...
CREATE TABLE BAS_DAM_DOSSIER (
    techId INTEGER PRIMARY KEY,
    Aangevraagd_bedrag double precision,
    ...
    Berekende_rente double precision,
    ...
    Octrooien integer,
    Offertebedrag double precision,
    ...
    Rente_perc double precision,
    Samenwerkingsverband1 varchar (1),
    Samenwerkingsverband2 varchar (1),
    SO_loon double precision,
    Begrote_SO_loonsom double precision,
    SO_uren bigint,
    Startmaand integer,
    ...
    Titel varchar (200),
    Afgelost_op_onvoorw_hoofdsom double precision,
    Afgelost_op_onvoorw_rente double precision,
    Totaal_afgelost_op_hoofdsom double precision,
    Totaal_ontvangen_rente double precision,
    Totaal_bijgeschreven_rente double precision,
    Direct_opeisbare_vordering double precision,
    Direct_opeisbare_hoofdsom double precision,
    Direct_opeisbare_rente double precision,
    Totaal_gecommitteerd_bedrag double precision,
    Zegge_Totaal_gecommitteerd varchar (100),
    Totaal_gedeclareerd_bedrag double precision,
    Totaal_geschoonde_kosten double precision,
    Totale_hoofdsom double precision,
    Totaal_ingetrokken_bedrag double precision,
    Kwijtsch_onvoorw_hoofdsom double precision,
    Kwijtsch_onvoorw_rente double precision,
    Kwijtsch_direct_opeisbaar double precision,
    Kwijtsch_voorw_hoofdsom double precision,
    Kwijtsch_voorw_rente double precision,
    Totaal_kwijtgescholden_bedrag double precision,
    Totaal_openstaand_bedrag double precision,
    Direct_opeisbaar_gesteld double precision,
    Totaal_uitbetaald double precision,
    Totaal_verleend_bedrag double precision,
    Uitlening_binnen_Fisc_eenheid varchar (1),
    Uurloon_jaar integer,
    Vaststellen_batch varchar (1),
    Vergoedingsperc double precision,
    Volgnr_LB smallint,
    Voorlopig_gecommitteerd double precision,
    Voorlopig_gedeclareerd double precision,
...
CREATE TABLE BAS_DAR_COR_BERICHT_BIJLAGE (
    techId INTEGER PRIMARY KEY,
    ARCHIEF_COR_BIJLAGE_ID integer,
    BRON varchar (6),
...
CREATE TABLE BAS_FAM_DECLARATIE (
    ...
    Einddatum timestamp,
    Totaal_ingediend double precision,
    Totaal_geschoond double precision,
    Vergoedings_pct double precision,
    Betalingsverzoeknummer varchar (40),
    ...
    Netto_verstrekking double precision,
    Bruto_vergoeding double precision,
...
CREATE TABLE BAS_FAM_TRANSACTIE (
    ...
    Mutatie_dat timestamp,
    Mutatie_user varchar (30),
    Bedrag_ex_btw double precision,
    Vst_volgnr bigint,
    ...
    Storneren varchar (1),
    Vordering_bedrag double precision,
    Afgelost double precision,
    Kwijtgescholden double precision,
    ...
    Correctie_bedrag_bob double precision,
...
CREATE TABLE BAS_JZM_BEROEP (
    ...
    Bedrag_schade double precision,
    Bedrag_schade_nlg double precision,
...
CREATE TABLE BAS_JZM_BOB_WIZARD (
    techId INTEGER PRIMARY KEY,
    Jz_id bigint,
    Verleen_bedrag double precision,
    Betaal_bedrag double precision,
    Vaststelling_bedrag double precision,
    Tra_cd_1 varchar (3),
    Bedrag_tra_cd_1 double precision,
    Tra_cd_2 varchar (3),
    Bedrag_tra_cd_2 double precision,
    Tra_cd_3 varchar (3),
    Bedrag_tra_cd_3 double precision,
    Sts_cd_voor varchar (3),
    Sts_cd_na varchar (3),
    Verleend_voor double precision,
    Gedeclareerd_voor double precision,
    Betaald_voor double precision,
    Ingetrokken_voor double precision,
    Open_vordering_voor double precision,
    Open_verlening_voor double precision,
    Verleen_na double precision,
    Gedeclareerd_na double precision,
    Betaald_na double precision,
    Ingetrokken_na double precision,
    Open_vordering_na double precision,
    Open_verlening_na double precision,
    ...
    Tra_bedrag_beschikking_1 double precision,
    Tra_id_beschikking_2 bigint,
    Tra_cd_beschikking_2 varchar (3),
    Tra_bedrag_beschikking_2 double precision,
    Tra_id_afd bigint,
    Bedrag_afspraak_afd double precision,
...
CREATE TABLE BAS_RBM_ORG_JAAR (
    ...
    Mutatie_user varchar (30),
    Mutatie_dat timestamp,
    Omzet double precision,
    Loonsom double precision,
    So_loonsom double precision,
    Max_so_vermindering double precision,
    Peildatum timestamp,
    Aantal_so_werknemers bigint,
    Bron varchar (12),
    Senterniveau_jn varchar (1),
    Lb_verm_voorlopig double precision,
    Lb_vermindering_eindafrekening double precision,
    Balanstotaal double precision
);
...
CREATE TABLE BAS_RDM_BUDGETONDERVERDELING (
    ...
    Budget_uitputting double precision,
    Correctie_budget double precision,
    Creatie_dat timestamp,
    Creatie_user varchar (30),
    Jaar integer,
    ...
    Rpe_datum_van timestamp,
    Rpt_nr bigint,
    Verdeeld_budget double precision,
    Vrij_budget double precision
);
...
CREATE TABLE BAS_RDM_PERIODE (
    ...
    Comm_rente_pct double precision,
    ...
    Iban varchar (34),
    Bic varchar (11),
    Imvb double precision,
    Correctie_code varchar (5),
    Auto_oracle varchar (1),
    Boeking varchar (1),
    Fin_soort varchar (1),
    Kenmerk_lijn varchar (20),
    Aflossing double precision
);
...
CREATE TABLE BAS_RDM_PRG_OVEREENKOMST (
    ...
    Totaal_budget double precision,
    Creatie_user varchar (30),
    Creatie_dat timestamp,
    Mutatie_user varchar (30),
    Mutatie_dat timestamp,
...
CREATE TABLE BAS_VKM_TOEGEVOEGD_VAR_VELD (
    ...
    Prompt varchar (40),
    Min_waarde double precision,
    Max_waarde double precision,
...
CREATE TABLE BAS_VKM_VAR_GEGEVENS (
    techId INTEGER PRIMARY KEY,
    BEDRAG_01 double precision,
    BEDRAG_02 double precision,
    BEDRAG_03 double precision,
    BEDRAG_04 double precision,
    BEDRAG_05 double precision,
    BEDRAG_06 double precision,
    BEDRAG_07 double precision,
    BEDRAG_08 double precision,
    BEDRAG_09 double precision,
    BEDRAG_10 double precision,
    BEDRAG_11 double precision,
    BEDRAG_12 double precision,
    BEDRAG_13 double precision,
    BEDRAG_14 double precision,
    BEDRAG_15 double precision,
    BEDRAG_16 double precision,
    BEDRAG_17 double precision,
    BEDRAG_18 double precision,
    BEDRAG_19 double precision,
    BEDRAG_20 double precision,
    BEDRAG_21 double precision,
    BEDRAG_22 double precision,
    BEDRAG_23 double precision,
    BEDRAG_24 double precision,
    BEDRAG_25 double precision,
    BEDRAG_26 double precision,
    BEDRAG_27 double precision,
    BEDRAG_28 double precision,
    BEDRAG_29 double precision,
    BEDRAG_30 double precision,
    BEDRAG_31 double precision,
    BEDRAG_32 double precision,
    BEDRAG_33 double precision,
    BEDRAG_34 double precision,
    BEDRAG_35 double precision,
    BEDRAG_36 double precision,
    BEDRAG_37 double precision,
    BEDRAG_38 double precision,
    BEDRAG_39 double precision,
    BEDRAG_40 double precision,
    Creatie_dat timestamp,
    Creatie_user varchar (30),
    DATUM_01 timestamp,
    DATUM_02 timestamp,
    ...
    Mutatie_dat timestamp,
    Mutatie_user varchar (30),
    NUMERIEK_01 double precision,
    NUMERIEK_02 double precision,
    NUMERIEK_03 double precision,
    NUMERIEK_04 double precision,
    NUMERIEK_05 double precision,
    NUMERIEK_06 double precision,
    NUMERIEK_07 double precision,
    NUMERIEK_08 double precision,
    NUMERIEK_09 double precision,
    NUMERIEK_10 double precision,
    NUMERIEK_11 double precision,
    NUMERIEK_12 double precision,
    NUMERIEK_13 double precision,
    NUMERIEK_14 double precision,
    NUMERIEK_15 double precision,
    NUMERIEK_16 double precision,
    NUMERIEK_17 double precision,
    NUMERIEK_18 double precision,
    NUMERIEK_19 double precision,
    NUMERIEK_20 double precision,
    NUMERIEK_21 double precision,
    NUMERIEK_22 double precision,
    NUMERIEK_23 double precision,
    NUMERIEK_24 double precision,
    NUMERIEK_25 double precision,
    NUMERIEK_26 double precision,
    NUMERIEK_27 double precision,
    NUMERIEK_28 double precision,
    NUMERIEK_29 double precision,
    NUMERIEK_30 double precision,
    NUMERIEK_31 double precision,
    NUMERIEK_32 double precision,
    NUMERIEK_33 double precision,
    NUMERIEK_34 double precision,
    NUMERIEK_35 double precision,
    NUMERIEK_36 double precision,
    NUMERIEK_37 double precision,
    NUMERIEK_38 double precision,
    NUMERIEK_39 double precision,
    NUMERIEK_40 double precision,
